...
<head>
    ...
    <title>Create Account — Login Form Project</title>
...
<div class="auth-form">
    ...
    if ($error === 'email_exists'): ?>
        <div class="alert alert-error">
            That email is already registered. <a href="loginform.php" style="color:inherit;text-decoration:underline;">Sign in instead?</a>
        </div>
    ...
    <form action="register.php" method="POST" id="registerForm" novalidate>
        ...
        <div class="field">
            ...
            <div class="input-icon-wrap">
                ...
                <button type="button" class="eye-toggle" id="eyeToggle" aria-label="Show password" title="Show password">&#128065;</button>
            </div>
            <p class="password-hint">Min. 8 chars · one uppercase · one number · one special character</p>
            <div class="field-error">Password does not meet requirements</div>
        </div>
...
<script>
    ...
    /* Registration specific client-side regex check */
    ...
    form.addEventListener('submit', e => {
        ...
        form.querySelectorAll('input[required]').forEach(el => {
            ...
            if (!bad && el.id === 'password') bad = !pwdPattern.test(el.value);
